  ...
  ------------------------------------------------------------*/
    ...
    --------------------------------------------------------------*/
		$('.barger-menu').on('click', function (e) {
			$(
				'.aximo-sidemenu-column, .offcanvas-overlay'
			).addClass('active');
			event.preventDefault(e);
		});
		$(
			'.aximo-sidemenu-close, .offcanvas-overlay'
		).on('click', function () {
			$(
				'.aximo-sidemenu-column, .offcanvas-overlay'
			).removeClass('active');
    ...
    AXIMO PROJECT SLIDER2 JS INIT
    ------------------------------------------------------------*/
		var aximo_project_slider2 = new Swiper(
    ...
    AXIMO PROJECT SLIDER JS INIT
    ------------------------------------------------------------*/
		var aximo_instagram_slider = new Swiper(
			'.aximo-instagram-slider',
			{
				loop: true,
				// Responsive breakpoints
				breakpoints: {
    ...
    ------------------------------------------------------------*/
		...
		var activeImage;
		gsap.utils
			.toArray('.aximo-service-increase-row')
			.forEach(function (el) {
				var image = el.querySelector(
						'img.swipeimage'
					),
					setX,
					setY,
